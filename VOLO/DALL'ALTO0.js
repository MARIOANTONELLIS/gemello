...
function init() {
	...
	if ( /soft/i.test(location.search) ) {
		...
		//renderer = new THREE.CanvasRenderer();
		//default renderer
		renderer = new THREE.CanvasRenderer();//default renderer
		console.log('canvas renderer');
	}
	...
	var materials = [
		...
		loadTexture( 'DALL'ALTO03.jpg' ), // right
		loadTexture( 'DALL'ALTO01.jpg' ), // left
		loadTexture( 'DALL'ALTO05.jpg' ), // top
		loadTexture( 'DALL'ALTO06.jpg' ), // bottom
		loadTexture( 'DALL'ALTO04.jpg' ), // back
		loadTexture( 'DALL'ALTO02.jpg' )  // front
	...
	lat=-37.748681312963015 ;lon=360-(66.6526671508684) //starting lookat);
