...
function init() {
	...
	var materials = [
		...
		loadTexture( 'DA_EST13.jpg' ), // right
		loadTexture( 'DA_EST11.jpg' ), // left
		loadTexture( 'DA_EST15.jpg' ), // top
		loadTexture( 'DA_EST16.jpg' ), // bottom
		loadTexture( 'DA_EST14.jpg' ), // back
		loadTexture( 'DA_EST12.jpg' )  // front
	...
	lat=-31.75179035946192 ;lon=360-(102.33167151604084) //starting lookat);
