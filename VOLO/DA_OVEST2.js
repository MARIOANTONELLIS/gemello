...
function init() {
	...
	var materials = [
		...
		loadTexture( 'DA_OVEST23.jpg' ), // right
		loadTexture( 'DA_OVEST21.jpg' ), // left
		loadTexture( 'DA_OVEST25.jpg' ), // top
		loadTexture( 'DA_OVEST26.jpg' ), // bottom
		loadTexture( 'DA_OVEST24.jpg' ), // back
		loadTexture( 'DA_OVEST22.jpg' )  // front
	...
	lat=-49.984920752997425 ;lon=360-(16.442579739608004) //starting lookat);
