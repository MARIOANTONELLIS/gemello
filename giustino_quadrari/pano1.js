...
function init() {
	...
	var materials = [
		...
		loadTexture( 'pano13.jpg' ), // right
		loadTexture( 'pano11.jpg' ), // left
		loadTexture( 'pano15.jpg' ), // top
		loadTexture( 'pano16.jpg' ), // bottom
		loadTexture( 'pano14.jpg' ), // back
		loadTexture( 'pano12.jpg' )  // front
	...
	lat=-30.82968895966752 ;lon=360-(-112.97191937124992) //starting lookat);
